...
public class LoadAppListService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this,"JexKids","Parental Control Enabled");
        }
    }
    ...
    protected void onHandleIntent(Intent handleIntent) {
        ...
        boolean isInitFaviter = MainUtil.getInstance().getBoolean(AppConstants.LOCK_IS_INIT_FAVITER, false);
        boolean isInitDb = MainUtil.getInstance().getBoolean(AppConstants.LOCK_IS_INIT_DB, false);
        if (!isInitFaviter) {
