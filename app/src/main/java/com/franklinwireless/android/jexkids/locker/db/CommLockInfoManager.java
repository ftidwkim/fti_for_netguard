package com.franklinwireless.android.jexkids.locker.db;
...
import com.franklinwireless.android.jexkids.locker.model.FaviterInfo;
import com.franklinwireless.android.jexkids.locker.utils.DataUtil;
...
public class CommLockInfoManager {
    ...
    public synchronized void instanceCommLockInfoTable(@NonNull List<ResolveInfo> resolveInfos) throws PackageManager.NameNotFoundException {
        ...
        for (ResolveInfo resolveInfo : resolveInfos) {
            ...
            /*if (resolveInfo == null || (appInfo = resolveInfo.activityInfo.applicationInfo) == null
                    || !appInfo.enabled || packageNameSet.contains(appInfo.packageName)) {
                continue;
            }
            else
            {
            ...
            packageNameSet.add(appInfo.packageName);*/
            if (!commLockInfo.getPackageName().equals(AppConstants.APP_PACKAGE_NAME) ) {
                if (isfaviterApp) {
                    commLockInfo.setLocked(false);
                } else {
