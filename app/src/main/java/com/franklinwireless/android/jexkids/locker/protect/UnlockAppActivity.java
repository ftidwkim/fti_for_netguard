package com.franklinwireless.android.jexkids.locker.protect;
...
import com.franklinwireless.android.jexkids.locker.utils.StatusBarUtil;
...
import com.franklinwireless.android.jexkids.locker.widget.UnLockMenuPopWindow;
    ...
    private void initLayoutBackground() {
        try {
            ...
            if (appInfo != null) {
                ...
                mUnlockFailTip.setText(appLabel+" "+getString(R.string.lock_label));
            ...
            public void onPatternDetected(@NonNull List<LockPatternView.Cell> pattern) {
                if (mLockPatternUtils.checkPattern(pattern)) { //
                    ...
                    if (actionFrom.equals(AppConstants.LOCK_FROM_LOCK_MAIN_ACITVITY)) {
                        startActivity(new Intent(UnlockAppActivity.this, Homepage.class));
                        finish();
                    } else {
...
//                        sendBroadcast(intent);
                        MyApp.getInstance().lastLockedTime = System.currentTimeMillis();
                        MyApp.getInstance().lastLockedPkgName = pkgName;
